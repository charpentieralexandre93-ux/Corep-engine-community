# COREP CRR3 Engine Community — v6.10.1
...
1. `INSTALL_WINDOWS.bat` — crée `.venv` et installe COREP Engine Community v6.10.1.
...
| Vérification release | `corep-community-release-verify --root . --manifest RELEASE_MANIFEST.json --version 6.10.1` |
