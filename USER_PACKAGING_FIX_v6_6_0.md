# COREP v6.6.0 — Correctif packaging utilisateur Windows
...
- Suppression des anciens `RELEASE_REPORT_v*` sauf `v6_6_0`.
- Suppression des anciens `VALIDATION_v*` sauf `v6_6_0`.
- Suppression des anciens SBOM sauf `v6.6.0`.
- Les changelogs historiques sont conservés comme historique produit.

## Version

La version reste `6.6.0`.
