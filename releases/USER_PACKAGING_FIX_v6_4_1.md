# COREP v6.4.1 — Correctif packaging utilisateur Windows
...
- Suppression des anciens `RELEASE_REPORT_v*` sauf `v6_4_1`.
- Suppression des anciens `VALIDATION_v*` sauf `v6_4_1`.
- Suppression des anciens SBOM sauf `v6.4.1`.
- Les changelogs historiques sont conservés comme historique produit.

## Version

La version reste `6.4.1`.
