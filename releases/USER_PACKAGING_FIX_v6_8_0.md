# COREP v6.8.0 — Correctif packaging utilisateur Windows
...
- Suppression des anciens `RELEASE_REPORT_v*` sauf `v6_8_0`.
- Suppression des anciens `VALIDATION_v*` sauf `v6_8_0`.
- Suppression des anciens SBOM sauf `v6.8.0`.
- Les changelogs historiques sont conservés comme historique produit.

## Version

La version reste `6.8.0`.
