...
Official submission remains `NO_GO` until the external regulatory and legal gates in `evidence/regulatory_dossier_v6_4_1.json` are marked `PASSED` with signed evidence.
