...
Official submission remains `NO_GO` until the external regulatory and legal gates in `evidence/regulatory_dossier_v6_7_0.json` are marked `PASSED` with signed evidence.

## Patch P1 interne — v6.7.0 conservée

Cette archive conserve le numéro **6.7.0** et ajoute une consolidation P1 sans changement volontaire des formules réglementaires :
