...
def _traceability_rows_for_edition(edition: str) -> tuple[tuple[str, str, str, str, str, str, str, str], ...]:
...
def official_submission_scope_from_matrix(matrix: Sequence[Mapping[str, object]]) -> dict[str, object]:
...
def validate_official_submission_scope(payload: Mapping[str, object]) -> tuple[str, ...]:
    ...
    expected_pairs = sorted(
        ...
        for item in expected["excluded_engine_modules"]  # type: ignore[index]
    )
