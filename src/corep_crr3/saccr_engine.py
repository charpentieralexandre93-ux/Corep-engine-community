...
_SF: Dict[str, float] = {
    "IRD": 0.005,
    "FX": 0.040,
    # Crédit single-name par échelon de qualité — Art.280c, table 2 (v6.9.0) :
    "CREDIT_CQS1": 0.0038,
    "CREDIT_CQS2": 0.0042,
    "CREDIT_CQS3": 0.0054,
    "CREDIT_CQS4": 0.0106,
    "CREDIT_CQS5": 0.0160,
    "CREDIT_CQS6": 0.0600,
    # Indices crédit — Art.280c, table 2 :
    "CREDIT_INDEX_IG": 0.0038,
    "CREDIT_INDEX_NIG": 0.0106,
    # Compat ascendante : classes agrégées historiques (données sans CQS).
    # IG≈CQS2 conservé à 0,5 % ; HY aligné CQS4 (Art.280c t.2, était 1,0 %).
    "CREDIT_IG": 0.005,
    "CREDIT_HY": 0.0106,
    "EQUITY_SINGLE": 0.320,
    "EQUITY_INDEX": 0.200,
    # Matières premières — Art.280f, table 5 : électricité 40 %, autres 18 %.
    "COMMODITY_ELECTRICITY": 0.400,
...
def run_saccr_engine(
    ...
    all_trades: List[SaccrTradeRow] = cast(
        List[SaccrTradeRow],
        db.query(
            """
        SELECT
