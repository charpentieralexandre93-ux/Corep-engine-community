...
-- Migration idempotente v6.3.0 : contrat de persistance SA (Community).
...
-- Migration corrective v6.3.0 : CQS alphanumérique (1..6 ou UNRATED).
ALTER TABLE core.core_standard_results
    ALTER COLUMN cqs_used TYPE VARCHAR(20)
    USING cqs_used::text;
