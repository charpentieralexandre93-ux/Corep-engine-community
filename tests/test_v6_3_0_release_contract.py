"""Release contract for the generated Community v6.10.1 source project."""
...
def test_public_product_entry_points_and_version_are_explicit() -> None:
    ...
    assert 'version = "6.10.1"' in pyproject
    assert '__version__ = "6.10.1"' in init_py
    assert readme.startswith("# COREP CRR3 Engine Community — v6.10.1\n")
...
def test_public_quality_policy_covers_gui_and_complexity() -> None:
    ...
    assert "max-complexity = 16" in pyproject  # ratchet v6.10.1
